...
# Optional terrace with conditional input
terrace = st.checkbox("Terrace")

if terrace:
    terrace_area_option = st.selectbox(
        "Terrace Area (m²)",
        options=["Unknown"] + list(range(0, 151))  # 0–150 m² + Unknown
    )
...
state_of_building = st.selectbox(
    "State",
    options=['Excellent','To be renovated','New','Normal','Fully renovated',
             'To renovate','Under construction','To demolish','To restore']
)
